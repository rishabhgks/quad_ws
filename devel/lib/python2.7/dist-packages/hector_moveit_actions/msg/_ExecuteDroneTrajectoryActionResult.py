...
"""autogenerated by genpy from hector_moveit_actions/ExecuteDroneTrajectoryActionResult.msg. Do not edit."""
import sys
...
class ExecuteDroneTrajectoryActionResult(genpy.Message):
  _md5sum = "2292985166bb5b541f66b36888e0add4"
  _type = "hector_moveit_actions/ExecuteDroneTrajectoryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hector_moveit_actions/ExecuteDroneTrajectoryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ExecuteDroneTrajectoryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hector_moveit_actions.msg.ExecuteDroneTrajectoryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hector_moveit_actions.msg.ExecuteDroneTrajectoryResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.result_code))
