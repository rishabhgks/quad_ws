...
let ExecuteDroneTrajectoryFeedback = require('./ExecuteDroneTrajectoryFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ExecuteDroneTrajectoryActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ExecuteDroneTrajectoryFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ExecuteDroneTrajectoryFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteDroneTrajectoryActionFeedback(null);
    ...
    data.feedback = ExecuteDroneTrajectoryFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteDroneTrajectoryActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExecuteDroneTrajectoryFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExecuteDroneTrajectoryFeedback()
    }
...
module.exports = ExecuteDroneTrajectoryActionFeedback;
