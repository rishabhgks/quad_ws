...
class ExecuteDroneTrajectoryFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ExecuteDroneTrajectoryFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecuteDroneTrajectoryFeedback(null);
...
module.exports = ExecuteDroneTrajectoryFeedback;
