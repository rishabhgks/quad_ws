...
if("TRUE" STREQUAL "TRUE")
  set(geotf_SOURCE_PREFIX /home/rishabh/quad_ws/src/geodetic_utils/geotf)
  set(geotf_DEVEL_PREFIX /home/rishabh/quad_ws/devel)
  set(geotf_INSTALL_PREFIX "")
  set(geotf_PREFIX ${geotf_DEVEL_PREFIX})
else()
  set(geotf_SOURCE_PREFIX "")
  set(geotf_DEVEL_PREFIX "")
  set(geotf_INSTALL_PREFIX /home/rishabh/quad_ws/install)
...
if(NOT "/home/rishabh/quad_ws/src/geodetic_utils/geotf/include " STREQUAL " ")
  set(geotf_INCLUDE_DIRS "")
  set(_include_dirs "/home/rishabh/quad_ws/src/geodetic_utils/geotf/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geotf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rishabh/quad_ws/src/geodetic_utils/geotf/${idir}'.  ${_report}")
    endif()
