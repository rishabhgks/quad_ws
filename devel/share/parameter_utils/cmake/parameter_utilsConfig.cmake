...
if("TRUE" STREQUAL "TRUE")
  set(parameter_utils_SOURCE_PREFIX /home/rishabh/quad_ws/src/blam/parameter_utils)
  set(parameter_utils_DEVEL_PREFIX /home/rishabh/quad_ws/devel)
  ...
  set(parameter_utils_INSTALL_PREFIX /home/rishabh/quad_ws/install)
...
if(NOT "/home/rishabh/quad_ws/src/blam/parameter_utils/include " STREQUAL " ")
  set(parameter_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/rishabh/quad_ws/src/blam/parameter_utils/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'parameter_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rishabh/quad_ws/src/blam/parameter_utils/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND parameter_utils_EXPORTED_TARGETS ${${parameter_utils_dep}_EXPORTED_TARGETS})
endforeach()
