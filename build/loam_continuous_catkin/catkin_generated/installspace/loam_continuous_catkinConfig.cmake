...
if(loam_continuous_catkin_CONFIG_INCLUDED)
  return()
endif()
set(loam_continuous_catkin_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(loam_continuous_catkin_SOURCE_PREFIX /home/rishabh/quad_ws/src/loam_continuous_catkin)
  set(loam_continuous_catkin_DEVEL_PREFIX /home/rishabh/quad_ws/devel)
  set(loam_continuous_catkin_INSTALL_PREFIX "")
  set(loam_continuous_catkin_PREFIX ${loam_continuous_catkin_DEVEL_PREFIX})
else()
  set(loam_continuous_catkin_SOURCE_PREFIX "")
  set(loam_continuous_catkin_DEVEL_PREFIX "")
  set(loam_continuous_catkin_INSTALL_PREFIX /home/rishabh/quad_ws/install)
  set(loam_continuous_catkin_PREFIX ${loam_continuous_catkin_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'loam_continuous_catkin' is deprecated")
...
set(loam_continuous_catkin_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/hdf5/openmpi;/usr/include/tcl;/usr/include/python2.7;/usr/include/libxml2 " STREQUAL " ")
  set(loam_continuous_catkin_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/hdf5/openmpi;/usr/include/tcl;/usr/include/python2.7;/usr/include/libxml2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${loam_continuous_catkin_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'loam_continuous_catkin' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'loam_continuous_catkin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(loam_continuous_catkin_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND loam_continuous_catkin_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND loam_continuous_catkin_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT loam_continuous_catkin_NUM_DUMMY_TARGETS)
      set(loam_continuous_catkin_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::loam_continuous_catkin::wrapped-linker-option${loam_continuous_catkin_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR loam_continuous_catkin_NUM_DUMMY_TARGETS "${loam_continuous_catkin_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::loam_continuous_catkin::wrapped-linker-option${loam_continuous_catkin_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND loam_continuous_catkin_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rishabh/quad_ws/install/lib;/home/rishabh/quad_ws/devel/lib;/home/rishabh/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(loam_continuous_catkin_LIBRARY_DIRS ${lib_path})
      list(APPEND loam_continuous_catkin_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'loam_continuous_catkin'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND loam_continuous_catkin_LIBRARIES ${lib})
    endif()
  endif()
...
set(loam_continuous_catkin_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${loam_continuous_catkin_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 loam_continuous_catkin_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${loam_continuous_catkin_dep}_FOUND)
      find_package(${loam_continuous_catkin_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${loam_continuous_catkin_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(loam_continuous_catkin_INCLUDE_DIRS ${${loam_continuous_catkin_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(loam_continuous_catkin_LIBRARIES ${loam_continuous_catkin_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${loam_continuous_catkin_dep}_LIBRARIES})
  _list_append_deduplicate(loam_continuous_catkin_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(loam_continuous_catkin_LIBRARIES ${loam_continuous_catkin_LIBRARIES})

  _list_append_unique(loam_continuous_catkin_LIBRARY_DIRS ${${loam_continuous_catkin_dep}_LIBRARY_DIRS})
  list(APPEND loam_continuous_catkin_EXPORTED_TARGETS ${${loam_continuous_catkin_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${loam_continuous_catkin_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
